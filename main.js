function addSubdomain() {
  ...
  function processDomains() {
    ...
    //sub = `${sub_domain.value}`;
      ...
      // sub = `${sub_domain.value}`;
        ...
        document.getElementById("new_records3").value="";
       }
  ...
  const pop1 = document.querySelector('.modal2');
  function show2() {
...
function ConvertTo() {
           ...
           else if(selectedRadio && (selectedRadio.id==="24"))
           { result="";
            result = ipAddresses.map(function(ip)
            {
              var parts = ip.trim().split('.');
           ...
           else if(selectedRadio && (selectedRadio.id==="16"))
           { result="";
            result = ipAddresses.map(function(ip)
            {
              var parts = ip.trim().split('.');
           ...
           else if(selectedRadio && (selectedRadio.id==="14"))
           { result="";
            result = ipAddresses.map(function(ip)
            {
              var parts = ip.trim().split('.');
